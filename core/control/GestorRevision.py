...
class GestorRevision:
    def __init__(self, eventosSismicosAd: list[EventoSismico] = None, eventoSismicoSeleccionado: EventoSismico = None, pantallaRevision:PantallaRevision=None):
        self.eventosSismicosAd = eventosSismicosAd if eventosSismicosAd is not None else []
    ...
    def tomarEvento(self, evento_id: int) -> None:
        self.eventoSismicoSeleccionado = self.eventosSismicos.get(id=evento_id)
        try:
